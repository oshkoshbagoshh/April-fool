<?php
// TODO: import page specific templates, assets, icons, etc
?>
<!doctype html>
<html lang="en">
<head>
...
<!---->
    <style>
        ...
        .hero-section {
            ...
            /* TODO: change this to TFN SVG Background */
            /*url('https://picsum.photos/1920/1080') no-repeat center center;*/
...
<section class="hero-section">
    <div class="container text-center">
        <div data-aos="fade-up" data-aos-duration="1000">
            <h1 class="display-4">The new standard in &lt;insert industry here&gt;</h1>
            <p class="lead">
